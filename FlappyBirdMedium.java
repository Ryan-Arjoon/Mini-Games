...
public class FlappyBirdMedium implements ActionListener, MouseListener, KeyListener{
	...
	public static FlappyBirdMedium flappyBirdMedium;

	//constant variables for width and height of the frame
	public static final int WIDTH = 800, HEIGHT = 800;

	//create an instance of Renderer
	public FlappyBirdMediumRenderer render;
	...
	public FlappyBirdMedium()
	{
		...
		render = new FlappyBirdMediumRenderer();
	...
	public void repaint(Graphics g) {
		...
		{
			g.setFont(new Font("arial", 1, 25));//font);
			g.drawString("----------Press Esc to return to Main Menu----------", WIDTH / 2 - 275, 492);
		}
	...
	public static void main(String[] args){
		...
		flappyBirdMedium = new FlappyBirdMedium();
	...
	public void keyPressed(KeyEvent e) {
		...
		if (e.getKeyCode() == KeyEvent.VK_ESCAPE)//if the user presses the exit keyboard key it will return to main menu
		{
			MainMenu.main(null);
		} 
