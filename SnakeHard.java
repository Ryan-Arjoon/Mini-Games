...
public class SnakeHard implements ActionListener, KeyListener{

	//Initialize/Declare all variables and constants

	//Assign the class 'Snake' to variable 'snake'
	public static SnakeHard snake;
	...
	public SnakeHardRenderer renderPanel;
	...
	{		
		...
		object.add(renderPanel = new SnakeHardRenderer());
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (ticks % 0.5 == 0 && head != null && !gameOver && !paused )
		{
