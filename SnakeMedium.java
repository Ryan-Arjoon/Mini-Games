...
public class SnakeMedium implements ActionListener, KeyListener{

	//Initialize/Declare all variables and constants

	//Assign the class 'Snake' to variable 'snake'
	public static SnakeMedium snake;
	...
	public SnakeMediumRenderer renderPanel;
	...
	{		
		...
		object.add(renderPanel = new SnakeMediumRenderer());
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (ticks % 1 == 0 && head != null && !gameOver && !paused )
		{
